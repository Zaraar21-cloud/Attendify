...
> A simple web-application that helps students in maintaining their attendance with threshold calculation, and interactive "What-If" skip/attend simulation designed with a high-contrast Neubrutalism UI.
